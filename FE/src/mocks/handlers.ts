...
// 계약: AuthController.java / UserController.java (#7) / ScanController.java / SseHub.java (#21)
//
// VITE_ENABLE_MOCKS=true 환경에서만 활성화.
...
export const handlers = [
  ...
  http.get('/api/v1/dashboard/stats', () =>
    HttpResponse.json({
      ...
      fixedFindings: 93,
      trend: [
        { date: '2026-09-17', scans: 5, findings: 12 },
        { date: '2026-09-18', scans: 3, findings: 8  },
        { date: '2026-09-19', scans: 7, findings: 15 },
        { date: '2026-09-20', scans: 2, findings: 4  },
        { date: '2026-09-21', scans: 8, findings: 18 },
        { date: '2026-09-22', scans: 6, findings: 11 },
        { date: '2026-09-23', scans: 4, findings: 9  },
      ],
    }),
  ),
